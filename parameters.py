...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        dataset_dir='/home/balaji/Documents/AED_research/seld-dcase2022-main/data_set_mono/',

        # OUTPUT PATHS
        # feat_label_dir='DCASE2020_SELD_dataset/feat_label_hnet/',  # Directory to dump extracted features and labels
        feat_label_dir='/home/balaji/Documents/AED_research/seld-dcase2022-main/data_set_mono/feat_label/',

        model_dir='/home/balaji/Documents/Ajay_san_PhD_work/seld-dcase2022-main/models/',
        # Dumps the trained models and training curves in this folder
        dcase_output_dir='/home/balaji/Documents/AED_research/seld-dcase2022-main/result/',
