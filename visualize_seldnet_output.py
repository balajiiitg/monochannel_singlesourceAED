...
def main(argv):
    ...
    checkpoint_name = "/home/balaji/Documents/Ajay_san_PhD_work/seld-dcase2022-main/models/1_1_dev_split0_accdoa_mic_gcc_model.h5"
    ...
    with torch.no_grad():
        ...
        for data, target in data_gen_test.generate():
            ...
            # target = torch.reshape(target, (72, 50,39))
